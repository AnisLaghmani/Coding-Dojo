...
function App() {
  ...
  return (
    <div className="App">
      <h1 className='m-3'>Countries App</h1>
      <form onSubmit={(e)=>{handleInput(e)}} className=''>
      ...
      <button onClick={fetchCountries} className='btn btn-success m-3'>Fetch Countries</button>
      <table className='table table-bordered'>
        ...
        {countries.map((country,index)=>{return <Display country={country} index={index} deleteCountry={deleteCountry} updateCountry={updateCountry}/>})}
      </table>
    </div>
  );
  }
